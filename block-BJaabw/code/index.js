...
// - Write a Function Decleration for above problem
function isInRange(num1,num2,n) {
...
function calculateBMI(weight = 0, height = 1) {
...
function sum(input1, input2) {
  if (isNaN(input2) == true && isNaN(input2) == true){ 
    return input1+input2;
  } else if (isNaN(input1) == false && isNaN(input2) == false) {
      return input1+input2;
  } else {
